        ...
        with open(defoci_file) as f:
            for line in f.readlines():
                ...
                if line_split[0] == "26": # the 26th tilt frame in a series, 0deg tilt
                    print(f"The 26th frame of {defoci_file.name}, tilt angle = {line_split[2]}, has defoci of {line_split[4]} nm and {line_split[5]}, mean defocus = {(float(line_split[4])+float(line_split[5]))/2} nm. \n")