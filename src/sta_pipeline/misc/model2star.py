...
path_to_model_directory = "./data/models" # Path to the directory containing the models (in .mod format)
...
path_to_model_directory = Path(path_to_model_directory).resolve() 
model_dict = {}
